...
public:
    ...
    void load() override {
        ...
        perspective.loadPerspective(85.0, 1.0, 900.0, (double)size.y / (double)size.x);

        /// TODO: Ajout des resources nécessaires.
        ResourcesManager::addResource("Dust", new Texture("Spotify_Logo_RGB_White.png"));

        mesh = new Mesh("../Assets/Meshes/gopher.obj", "Dust");
        mesh->translate(50.0, 0.0, 0.0);
        rotationX.loadXRotation(0.00);
        rotationY.loadYRotation(0.9);
        rotationZ.loadZRotation(0.00);
        rotationX.e14 = 50.0;
        rotationY.e14 = 50.0;
        rotationZ.e14 = 50.0;
        rotationX.e24 = 0.0;
    ...
    void unload() {
        delete mesh;
        ResourcesManager::removeResource("Dust");
    }    
