...
struct Matrix44d {
    ...
    void loadXRotation(double angle, Vector3d translation) {
    ...
    /// @param angle Angle de rotation en degrés.
    void loadYRotation(double angle, Vector3d translation) {
        angle = angle * PI / 180.0;
        loadIdentity();
        e11 = cos(angle);
        e13 = sin(angle);
    ...
    /// @param angle Angle de rotation en degrés.
    void loadZRotation(double angle, Vector3d translation) {
        angle = angle * PI / 180.0;
        loadIdentity();
        e11 = cos(angle);
        e12 = sin(angle);
    ...
    void loadRotation(double angle, Vector3d axis, Vector3d translation) {
        angle = angle * PI / 180.0;
        axis.unit();
        loadIdentity();
        double c = cos(angle);
